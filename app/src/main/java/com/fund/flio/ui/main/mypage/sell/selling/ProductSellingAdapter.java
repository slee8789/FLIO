...
public class ProductSellingAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private ArrayList<Product> products;


    public ProductSellingAdapter(ArrayList<Product> products) {
        this.products = products;
    }

    public void setItems(List<Product> products) {
        final ProductSellingAdapter.ProductDiffCallback diffCallback = new ProductSellingAdapter.ProductDiffCallback(this.products, products);
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemProductSellingBinding productBinding = ItemProductSellingBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public class ProductViewHolder extends BaseViewHolder {
        ...
        private ItemProductSellingBinding productBinding;

        public ProductViewHolder(ItemProductSellingBinding binding) {
