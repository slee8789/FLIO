...
public class ProductRegisterDetailFragment extends BaseFragment<FragmentProductRegisterDetailBinding, ProductRegisterDetailViewModel> implements OnFABMenuSelectedListener {
    ...
    @Override
    public ProductRegisterDetailViewModel getViewModel() {
        return getViewModelProvider().get(ProductRegisterDetailViewModel.class);
    }
