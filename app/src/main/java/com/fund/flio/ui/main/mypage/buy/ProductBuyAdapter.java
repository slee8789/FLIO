...
public class ProductBuyAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private ArrayList<Product> products;

//    private BuyListViewModel buyListViewModel;

//    public void setBuyListViewModel(BuyListViewModel buyListViewModel) {
//        this.buyListViewModel = buyListViewModel;
//    }

    public ProductBuyAdapter(ArrayList<Product> products) {
        this.products = products;
    }

    public void setItems(List<Product> products) {
        final ProductBuyAdapter.ProductDiffCallback diffCallback = new ProductBuyAdapter.ProductDiffCallback(this.products, products);
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemProductBuyBinding productBinding = ItemProductBuyBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public class ProductViewHolder extends BaseViewHolder {
        ...
        private ItemProductBuyBinding productBinding;

        public ProductViewHolder(ItemProductBuyBinding binding) {
...
//            productBinding.setViewModel(buyListViewModel);
        }
