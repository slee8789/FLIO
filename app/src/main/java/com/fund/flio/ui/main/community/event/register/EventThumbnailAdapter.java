...
public class EventThumbnailAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private ArrayList<Uri> uries;
    private EventRegisterViewModel eventRegisterViewModel;

    public void setEventRegisterViewModel(EventRegisterViewModel eventRegisterViewModel) {
        this.eventRegisterViewModel = eventRegisterViewModel;
    }

    public EventThumbnailAdapter(ArrayList<Uri> uries) {
        this.uries = uries;
    }

    public void setItems(List<Uri> uries) {
        final EventThumbnailAdapter.UriDiffCallback diffCallback = new EventThumbnailAdapter.UriDiffCallback(this.uries, uries);
...
//            thumbnailBinding.setViewModel(eventRegisterViewModel);
        }
