...
public class ProductThumbnailAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public ProductThumbnailAdapter(ArrayList<Uri> uries) {
        this.uries = uries;
    }

    public void setItems(List<Uri> uries) {
        final ProductThumbnailAdapter.UriDiffCallback diffCallback = new ProductThumbnailAdapter.UriDiffCallback(this.uries, uries);
