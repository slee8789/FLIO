...
public class FavoriteCertificateAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private ArrayList<Product> products;


    public FavoriteCertificateAdapter(ArrayList<Product> products) {
        this.products = products;
    }

    public void setItems(List<Product> products) {
        final FavoriteCertificateAdapter.ProductDiffCallback diffCallback = new FavoriteCertificateAdapter.ProductDiffCallback(this.products, products);
